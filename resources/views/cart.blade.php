                ...
                <tbody>
                    @foreach (Cart::instance('default')->content() as $item)
                        <tr>
                            ...
                            <td>IDR {{ format($item->subtotal) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <div class="summary">
                <div class="row">
                    ...
                    <div class="col-md-3 offset-md-1">
                        <p class="text-right light-text">Subtotal &nbsp; &nbsp;IDR {{ format(Cart::subtotal()) }}</p>
                        <p class="text-right light-text">Tax(21%) &nbsp; &nbsp;IDR {{ format(Cart::tax()) }}</p>
                        <p class="text-right">Total &nbsp; &nbsp; IDR {{ format(Cart::total()) }}</p>
                    </div>
                </div>
            </div>

<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <?php echo e(menu('main', 'partials.menu.main')); ?>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <?php endif; ?>
            <?php else: ?>
            <?php if(auth()->user()->can('browse_admin')): ?>
            <li class="nav-item">
...
<?php /**PATH D:\Laravel\e-commerce\ecommerce-laravel\resources\views/partials/nav.blade.php ENDPATH**/ ?>